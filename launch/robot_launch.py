...
"""Launch Webots TurtleBot4 driver."""
...
def get_ros2_nodes(*args):
    package_dir = get_package_share_directory('webots_turtlebot4')
    ...
    turtlebot_driver = Node(
        ...
        executable='driver',
        output='screen',
        additional_env={'WEBOTS_CONTROLLER_URL': controller_url_prefix() + 'Turtlebot4'},
        parameters=[
    ...
    ir_intensity_publisher = Node(
        package='webots_turtlebot4',
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'world',
            default_value='turtlebot4_room.wbt',
